...
#    Updated: 2023/11/21 08:17:05 by tunsal           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS_FOLDER				= utils
UTILS_SRCS					= $(UTILS_FOLDER)/str_is_numeric.c $(UTILS_FOLDER)/stack_print.c $(UTILS_FOLDER)/stack_get_smallest_elem_idx.c $(UTILS_FOLDER)/stack_is_sorted_asc.c 
