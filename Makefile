...
#    Updated: 2023/11/21 09:16:51 by tunsal           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS_FOLDER				= utils
UTILS_SRCS					= $(UTILS_FOLDER)/str_is_numeric.c $(UTILS_FOLDER)/stack_print.c $(UTILS_FOLDER)/stack_get_smallest_elem_idx.c $(UTILS_FOLDER)/stack_get_largest_elem_idx.c $(UTILS_FOLDER)/stack_is_sorted_asc.c $(UTILS_FOLDER)/exit_error.c
